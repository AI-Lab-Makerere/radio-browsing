...
class AudioTag(RootModel):
    ...
    tags = db.relationship('Tag', foreign_keys=[
                           tag_id], backref="audiotag", lazy=True, uselist=False)
    audios = db.relationship('Audio', foreign_keys=[
                             audio_id], backref="audiotag", lazy=True, uselist=False)
